        ...
        <div className="max-w-3xl mx-auto flex flex-col md:flex-row items-center gap-12 bg-white p-10 md:p-16 rounded-[3rem] shadow-sm border border-gray-100">
          ...
          <div>
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              Você tem <strong>7 dias inteiros</strong> para testar o <strong>Método Oneway</strong>. Se por QUALQUER motivo você achar que não é para você, ou se simplesmente não gostar da cor do PDF, eu devolvo 100% do seu dinheiro. Sem perguntas, sem burocracia e sem ressentimentos.
            </p>
