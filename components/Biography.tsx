        ...
        <div className="flex flex-col md:flex-row items-center gap-12 max-w-5xl mx-auto">
          ...
          <div className="md:w-2/3">
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              Viajante experiente e especialista em processos consulares, Max Millian Martins já ajudou muitos brasileiros aprovados a conseguirem o tão sonhado visto americano sem depender de intermediários.
            </p>
            ...
            <div className="flex gap-4">
               <div className="text-center bg-white p-6 rounded-3xl flex-1 border border-gray-50 shadow-[0_15px_30px_rgba(0,0,0,0.06)]">
                  <p className="text-2xl font-black text-[#B31942] uppercase">Muitos</p>
                  <p className="text-[10px] text-gray-400 uppercase font-black tracking-widest mt-1">Brasileiros Aprovados</p>
               </div>
               <div className="text-center bg-white p-6 rounded-3xl flex-1 border border-gray-50 shadow-[0_15px_30px_rgba(0,0,0,0.06)]">
